/*
  ...
  3. 列表与详情接口返回字段；
  4. pitb_review_expert(1).sql 仅用于交叉核对。
...
-- ----------------------------
-- 评标专家库
-- 命名结构：业务模块 pitb + 功能 review_expert
-- ----------------------------
CREATE TABLE `pitb_review_expert` (
  `id` bigint NOT NULL COMMENT '主键，雪花ID',
  `expert_code` varchar(20) NOT NULL COMMENT '专家账号',
  `expert_name` varchar(50) NOT NULL COMMENT '专家姓名',
  `expert_source_type` varchar(2) NOT NULL COMMENT '专家来源类型，字典：pitb_review_expert_source',
  ...
  UNIQUE KEY `uk_pitb_review_expert_active_code`
    (`tenant_code`, (CASE WHEN `del_flag` = '0' THEN `expert_code` ELSE NULL END)) USING BTREE,
  KEY `idx_pitb_review_expert_code_history` (`tenant_code`, `expert_code`, `del_flag`) USING BTREE,
  KEY `idx_pitb_review_expert_approval` (`tenant_code`, `approval_status`, `del_flag`) USING BTREE,
  KEY `idx_pitb_review_expert_dept` (`tenant_code`, `dept_code`, `department_code`, `del_flag`) USING BTREE,
  KEY `idx_pitb_review_expert_create_time` (`tenant_code`, `create_time`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='评标专家库';

-- ----------------------------
-- 评标专家取得职称明细
-- ----------------------------
CREATE TABLE `pitb_review_expert_title` (
  `id` bigint NOT NULL COMMENT '主键，雪花ID',
  ...
  `del_flag` char(1) NOT NULL DEFAULT '0' COMMENT '删除标记：0正常，1删除',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `idx_pitb_review_expert_title_expert` (`tenant_code`, `expert_id`, `del_flag`) USING BTREE,
  KEY `idx_pitb_review_expert_title_date` (`tenant_code`, `obtain_date`) USING BTREE
...
-- ----------------------------
CREATE TABLE `pitb_review_expert_file` (
  `id` bigint NOT NULL COMMENT '主键，雪花ID',
  `expert_id` bigint NOT NULL COMMENT '专家主表ID',
  ...
  `del_flag` char(1) NOT NULL DEFAULT '0' COMMENT '删除标记：0正常，1删除',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `idx_pitb_review_expert_file_expert` (`tenant_code`, `expert_id`, `del_flag`) USING BTREE
